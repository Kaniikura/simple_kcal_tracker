...
extension CalorieEntryQueryWhereSort
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension CalorieEntryQueryWhere
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterWhereClause>
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterWhereClause> createdAtBetween(
...
extension CalorieEntryQuerySortBy
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<CalorieEntry, CalorieEntry, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CalorieEntryQuerySortThenBy
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<CalorieEntry, CalorieEntry, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
...
extension CalorieEntryQueryWhereDistinct
  ...
  QueryBuilder<CalorieEntry, CalorieEntry, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension CalorieEntryQueryProperty
  ...
  QueryBuilder<CalorieEntry, int, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'amount');
    });
  }

  QueryBuilder<CalorieEntry, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
